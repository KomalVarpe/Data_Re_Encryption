...
<head>
	...
	<title>Data re-encryption using blockchain</title>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li><a href="owner_signin.jsp">Data Owner log-in</a></li>
					<li><a href="Signin.jsp">Service Providers log-in</a></li>
					<li><a href="admin_signin.jsp">User log-in</a></li>
	...
	<header id="head3">
		<div class="container">
			<div class="banner-content">
				<div id="da-slider" class="da-slider" style="padding-left:0px;">
					    <div class="da-slide">
					...
					<div class="da-slide">
						<h2>Re-Encryption Approach <br> to <br>Secure Data Sharing  Based <br> on Blockchain</h2>
